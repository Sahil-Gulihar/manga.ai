...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed p-2 sm:p-4 lg:p-6 relative" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(/backdrop.jpg)' }}>
                ...
                >
                  <div className="lg:col-span-5 flex flex-col">
                    ...
                    <div className="mt-3 sm:mt-4 lg:mt-6 p-2 sm:p-3 lg:p-4">
                      <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-black bg-gradient-to-r from-black via-blue-900 to-purple-900 bg-clip-text text-transparent leading-tight">
